...
Simulacion::Simulacion(const Mapa &m, const Coordenada posInicial, map<Color,Coordenada> objetos): mapa_(m),
posicionActual_(posInicial), objetivosCompletados_(0), cantMovimientos_(0), objetivosTrie_(), objetivosDisponibles_(),
objetoEnPosicion_() {
